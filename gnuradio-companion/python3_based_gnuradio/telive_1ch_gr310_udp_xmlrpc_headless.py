...
# Title: SQ5BPF Tetra live receiver 1ch UDP HEADLESS for
# Author: Jacek Lipkowski SQ5BPF
# Description: 1 channel receiver for Telive, with XMLRPC server and UDP output
...
class telive_1ch_gr310_udp_xmlrpc_headless(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "SQ5BPF Tetra live receiver 1ch UDP HEADLESS for", catch_exceptions=True)
...
def main(top_block_cls=telive_1ch_gr310_udp_xmlrpc_headless, options=None):
    tb = top_block_cls()
