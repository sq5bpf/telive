...
# Generated: Sat Jun 11 22:52:51 2016
##################################################
...
class top_block(gr.top_block):
    ...
    def __init__(self):
        ...
        self.fractional_resampler_xx_0_4 = filter.fractional_resampler_cc(0, float(float(if_samp_rate)/float(out_sample_rate)))
        self.fractional_resampler_xx_0_3 = filter.fractional_resampler_cc(0, float(float(if_samp_rate)/float(out_sample_rate)))
        self.fractional_resampler_xx_0_2 = filter.fractional_resampler_cc(0, float(float(if_samp_rate)/float(out_sample_rate)))
        ...
        self.connect((self.analog_agc3_xx_0_0_0_0, 0), (self.fractional_resampler_xx_0_2, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0_0_0_0, 0), (self.analog_agc3_xx_0_0_0_0, 0))
        self.connect((self.fractional_resampler_xx_0_2, 0), (self.blocks_udp_sink_0_2, 0))
        self.connect((self.osmosdr_source_0, 0), (self.freq_xlating_fir_filter_xxx_0_0_0_0, 0))
        self.connect((self.analog_agc3_xx_0_0_0_0_0, 0), (self.fractional_resampler_xx_0_3, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0_0_0_0_0, 0), (self.analog_agc3_xx_0_0_0_0_0, 0))
        self.connect((self.fractional_resampler_xx_0_3, 0), (self.blocks_udp_sink_0_4, 0))
        ...
        self.connect((self.fractional_resampler_xx_0_4, 0), (self.blocks_udp_sink_0_3, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0_0_0_0_0_0, 0), (self.analog_agc3_xx_0_0_0_0_0_0, 0))
        self.connect((self.analog_agc3_xx_0_0_0_0_0_0, 0), (self.fractional_resampler_xx_0_4, 0))
    ...
    def set_out_sample_rate(self, out_sample_rate):
        ...
        self.fractional_resampler_xx_0_2.set_resamp_ratio(float(float(self.if_samp_rate)/float(self.out_sample_rate)))
        self.fractional_resampler_xx_0_3.set_resamp_ratio(float(float(self.if_samp_rate)/float(self.out_sample_rate)))
        self.fractional_resampler_xx_0_4.set_resamp_ratio(float(float(self.if_samp_rate)/float(self.out_sample_rate)))
